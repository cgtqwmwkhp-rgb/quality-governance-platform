...
export default function RiskFormFields({
  form,
  onChange,
}: RiskFormFieldsProps) {
  return (
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ ...form, risk_owner_name: e.target.value })
          }
      ...
      <div className="border-t border-border pt-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ ...form, inherent_impact: Number(e.target.value) })
              }
            />
            <div className="flex justify-between text-xs text-muted-foreground">
              <span>Minor</span>
        ...
        <div className="mt-2 text-center">
          ...
          <span
            ...
            style={{
              color: levelToColor(
                scoreToLevel(form.inherent_likelihood * form.inherent_impact),
              ),
            }}
          >
      ...
      <div className="border-t border-border pt-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ ...form, residual_impact: Number(e.target.value) })
              }
            />
            <div className="flex justify-between text-xs text-muted-foreground">
              <span>Minor</span>
        ...
        <div className="mt-2 text-center">
          ...
          <span
            ...
            style={{
              color: levelToColor(
                scoreToLevel(form.residual_likelihood * form.residual_impact),
              ),
            }}
          >
      ...
      <div className="grid grid-cols-2 gap-4 border-t border-border pt-4">
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              onChange({ ...form, treatment_strategy: e.target.value })
            }
          >
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange({
                ...form,
                review_frequency_days: Number(e.target.value),
              })
            }
          />
        </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            onChange({ ...form, treatment_plan: e.target.value })
          }
