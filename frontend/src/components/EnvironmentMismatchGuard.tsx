    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-yellow-50 dark:bg-yellow-900/20 p-4">
        <div className="max-w-lg bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border-2 border-yellow-400">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">{mismatchError}</p>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            This is a safety measure to prevent cross-environment data access. Please ensure you're
            using the correct URL for your environment.
          </p>
