    ...
    return (
      <div className="p-6">
        <ErrorState
          ...
          message="Could not fetch complaint data. Please try again."
          onRetry={() => refetch()}
        />
      </div>
    );
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p className="text-sm mt-1">
                        Record a complaint to get started
                      </p>
                    </td>
                  </tr>
                ) : (
                  filteredComplaints.map((complaint, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <Badge
                          variant={
                            getStatusVariant(complaint.status) as BadgeVariant
                          }
                        >
