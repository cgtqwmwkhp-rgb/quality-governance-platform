    ...
    try {
      ...
      setEditForm({
        ...
        company_vehicle_registration:
          response.data.company_vehicle_registration,
  ...
  const handleCreateInvestigation = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await investigationsApi.createFromRecord({
        ...
        source_id: rta.id,
        title:
          investigationForm.title || `Investigation - ${rta.reference_number}`,
      });
      ...
      if (axiosErr.response?.status === 409) {
        ...
        if (
          ...
          setInvestigationError(
            "An investigation already exists for this RTA.",
          );
          return;
        }
      }
  ...
  const handleCreateAction = async (e: React.FormEvent) => {
    ...
    try {
      await actionsApi.create({
        ...
        description:
          actionForm.description || `Action for ${rta.reference_number}`,
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="pending_insurance">
                            Pending Insurance
                          </SelectItem>
              ...
              {isEditing ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-foreground">
                      {rta.company_vehicle_registration || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">
      ...
      <Dialog open={showActionModal} onOpenChange={setShowActionModal}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a corrective or follow-up action for this road traffic
              collision.
            </DialogDescription>
          </DialogHeader>
