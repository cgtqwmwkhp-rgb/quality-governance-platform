...
describe('standardsMatrixFilters', () => {
  ...
  it('bridges framework ids to Evidence API standard ids and specialist routes', () => {
    ...
    expect(complianceStandardIdFromFrameworkId('ce')).toBe('ce')
    expect(complianceStandardIdFromFrameworkId('cep')).toBe('cep')
    expect(complianceStandardIdFromFrameworkId('iip')).toBe('iip')
    expect(complianceStandardIdFromFrameworkId('chas')).toBeNull()
    expect(complianceStandardIdFromFrameworkId('ssip')).toBeNull()
    expect(complianceStandardIdFromFrameworkId('pm')).toBeNull()
    expect(complianceStandardIdFromFrameworkId('uvdb')).toBeNull()
