      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-card border border-border rounded-xl p-4 hover:border-border-strong transition-colors">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-2xl font-bold text-foreground">{predictions.length}</span>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-4 hover:border-border-strong transition-colors">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-2xl font-bold text-foreground">{anomalies.length}</span>
          </div>
            ...
            <div className="p-4 space-y-4">
              {predictions.length === 0 && (
                <div className="text-center py-8 text-muted-foreground text-sm">
                  Run analysis to generate risk predictions
                </div>
              )}
            ...
            <div className="p-4 space-y-4">
              {clusters.length === 0 && (
                <div className="text-center py-8 text-gray-400 text-sm">
                  Run analysis to detect incident clusters
                </div>
              )}
          ...
          <div className="bg-slate-800 rounded-xl border border-slate-700">
            ...
            <div className="p-4 space-y-3">
              {auditQuestions.length === 0 && (
                <div className="text-center py-8 text-gray-400 text-sm">
                  No audit questions generated yet
                </div>
              )}
        ...
        <div className="space-y-4">
          {recommendations.length === 0 && (
            <div className="text-center py-12 text-gray-400 text-sm">
              Run analysis to generate smart recommendations
            </div>
          )}
