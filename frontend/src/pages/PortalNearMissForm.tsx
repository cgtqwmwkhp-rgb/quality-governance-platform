...
const CONTRACT_OPTIONS = [
  {
    value: "TfL-Central",
    label: "TfL Central Line",
    sublabel: "London Underground",
  },
  {
    value: "TfL-Jubilee",
    label: "TfL Jubilee Line",
    sublabel: "London Underground",
  },
  {
    value: "NR-Southern",
    label: "Network Rail Southern",
    sublabel: "Maintenance",
  },
  {
    value: "NR-Western",
    label: "Network Rail Western",
    sublabel: "Maintenance",
  },
...
const SEVERITY_LEVELS = [
  ...
  },
  {
    value: "medium",
    label: "Medium",
    description: "Could cause injury",
    color: "bg-warning",
  },
  {
    value: "high",
      ...
      <div className="min-h-screen bg-surface flex items-center justify-center p-4">
        <Card className="p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Thank you for reporting this near miss. Your report helps us prevent
            future incidents.
          </p>
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Who is reporting this near miss?
              </p>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    potentialConsequences: e.target.value,
                  }))
                }
        ...
        {step === 4 && (
          <div className="space-y-5">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Suggest actions and add photos
              </p>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    preventiveActionSuggested: e.target.value,
                  }))
                }
