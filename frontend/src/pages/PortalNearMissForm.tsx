  ...
  if (submittedRef) {
    ...
    return (
      <div className="min-h-screen bg-surface flex items-center justify-center p-4">
        <Card className="p-8 max-w-md w-full text-center" data-testid="portal-nearmiss-success">
