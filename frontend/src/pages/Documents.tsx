              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <Badge
                      variant={getStatusVariant(doc.status) as BadgeVariant}
                      className="text-[10px]"
                    >
                      {doc.status}
                    </Badge>
          ...
          {selectedDocument && (
            <>
              ...
              <div className="overflow-y-auto max-h-[calc(90vh-160px)] space-y-6 py-4">
                ...
                {selectedDocument.ai_tags &&
                  selectedDocument.ai_tags.length > 0 && (
                    <div>
                ...
                {selectedDocument.ai_keywords &&
                  selectedDocument.ai_keywords.length > 0 && (
                    <div>
