...
import { useRTAs, useCreateRTA } from "../hooks/queries/useRTAs";
...
export default function RTAs() {
  ...
  const {
    ...
    isError,
    refetch,
  } = useRTAs({ page: 1, size: 50 });
  const createRTA = useCreateRTA();
  const rtas = rtasData?.items ?? [];
  ...
  if (isError) {
    return (
      <div className="p-6">
        <ErrorState
          title="Failed to load RTAs"
          message="Could not fetch road traffic collision data. Please try again."
          onRetry={() => refetch()}
        />
      </div>
    );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage vehicle accidents and incidents
          </p>
        </div>
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p className="text-sm mt-1">
                        Report a road traffic collision to get started
                      </p>
                    </td>
                  </tr>
                ) : (
                  filteredRtas.map((rta, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <Badge
                          variant={
                            getSeverityVariant(rta.severity) as BadgeVariant
                          }
                        >
                      ...
                      <td className="px-6 py-4">
                        <Badge
                          variant={getStatusVariant(rta.status) as BadgeVariant}
                        >
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Record details of a road traffic collision or near miss incident
          ...
          <form onSubmit={handleCreate} className="space-y-5">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      company_vehicle_registration: e.target.value,
                    })
                  }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, collision_date: e.target.value })
                }
              />
            </div>
            ...
            <DialogFooter className="gap-3 pt-4">
              ...
              <Button type="submit" disabled={createRTA.isPending}>
                {createRTA.isPending ? (
                  <>
