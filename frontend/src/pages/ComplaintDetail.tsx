...
export default function ComplaintDetail() {
  ...
  const witnessesValue: CaseWitnessesValue =
    witnessesDraft ?? {
      witnesses: (complaint?.witnesses_structured as CaseWitnessesValue | undefined)?.witnesses ?? [],
    }
  ...
  const handleSaveWitnesses = async () => {
    ...
    try {
      ...
      trackError(err, { component: 'ComplaintDetail', action: 'saveWitnesses' })
      toast.error(
      ...
      <Tabs defaultValue={defaultTab} key={defaultTab} className="w-full">
        <TabsList className="w-full justify-start flex-wrap h-auto gap-1 p-1">
          ...
          <TabsTrigger value="witnesses">
            ...
            {t('complaints.tabs.witnesses', 'Witnesses')}
          </TabsTrigger>
        ...
        <TabsContent value="witnesses" className="mt-6 space-y-4">
          ...
          {witnessesDraft ? (
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleSaveWitnesses} disabled={savingWitnesses} data-testid="complaint-witnesses-save">
