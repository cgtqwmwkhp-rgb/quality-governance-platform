    ...
    try {
      ...
      await investigationsApi.createFromRecord({
        ...
        title:
          ...
          `Investigation - ${complaint.reference_number}`,
      });
      ...
      if (axiosErr.response?.status === 409) {
        ...
        if (
          ...
          setInvestigationError(
            "An investigation already exists for this complaint.",
          );
          return;
        }
      }
  ...
  const handleCreateAction = async (e: React.FormEvent) => {
    ...
    try {
      await actionsApi.create({
        ...
        description:
          actionForm.description || `Action for ${complaint.reference_number}`,
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <Badge
                variant={getPriorityVariant(complaint.priority) as BadgeVariant}
              >
                {complaint.priority}
              </Badge>
              <Badge
                variant={getStatusVariant(complaint.status) as BadgeVariant}
              >
              ...
              {isEditing ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-foreground">
                      {complaint.complainant_name || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">
                    ...
                    <p className="mt-1 text-foreground">
                      {complaint.complainant_email || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">
                    ...
                    <p className="mt-1 text-foreground">
                      {complaint.complainant_phone || "Not specified"}
                    </p>
                  </div>
                </div>
              )}
      ...
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a root cause investigation for complaint{" "}
              {complaint.reference_number}. Data will be prefilled from the
              complaint record.
            </DialogDescription>
          </DialogHeader>
