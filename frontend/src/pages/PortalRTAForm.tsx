        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <FuzzySearchDropdown
              ...
              onChange={(val) =>
                setFormData((prev) => ({ ...prev, peVehicle: val }))
              }
            ...
            {formData.peVehicle === "other" && (
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    peVehicleOther: e.target.value.toUpperCase(),
                  }))
                }
              ...
              <div className="grid grid-cols-2 gap-3">
                {[true, false].map((val) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, hasPassengers: val }))
                    }
                    className={cn(
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      passengerDetails: e.target.value,
                    }))
                  }
              ...
              <Card key={index} className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateThirdParty(index, "driverName", e.target.value)
                    }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateThirdParty(index, "driverPhone", e.target.value)
                  }
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateThirdParty(index, "policyNumber", e.target.value)
                    }
                    placeholder="Policy #..."
                    className="text-sm"
                  />
              ...
              <div className="grid grid-cols-2 gap-3">
                {[true, false].map((val) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, isDrivable: val }))
                    }
                    className={cn(
                      "px-4 py-3 rounded-xl border-2 font-medium transition-all",
              ...
              <div className="grid grid-cols-6 gap-2">
                {WEATHER_OPTIONS.map((w) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, weather: w.value }))
                    }
                    className={cn(
          ...
          <div className="space-y-5">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      purposeOfJourney: e.target.value,
                    }))
                  }
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                type="button"
                onClick={() =>
                  setFormData((prev) => ({ ...prev, hasCCTV: !prev.hasCCTV }))
                }
                className={cn(
                  "flex items-center gap-2 p-3 rounded-xl border-2 transition-all",
                  formData.hasCCTV
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      emergencyServices: e.target.value,
                    }))
                  }
