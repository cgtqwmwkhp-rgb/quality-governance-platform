/**
 * Assurance Certificate Shelf panel
 *
 * Unified expiry-driven readiness view across compliance register,
 * Planet Mark, UVDB Achilles, and Governance Library masters.
 *
 * Rendered inside Compliance Schedule as its Certificates view, so it owns no
 * page heading of its own — the host page supplies the H1.
 */
...
export default function AssuranceCertShelfPanel() {
  ...
  return (
    <div className="space-y-6" data-testid="assurance-cert-shelf-panel">
