...
export default function ComplianceSchedule() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      toast.error(t('compliance.schedule.load_error', 'Could not load Compliance Schedule'))
    } finally {
      setLoading(false)
    }
  }, [statusFilter, t])
  ...
  return (
    <div className="space-y-6" data-testid="compliance-schedule-page">
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3" data-testid="compliance-schedule-stats">
          {(
            [
      ...
      <section className="rounded-lg border border-border bg-card">
        ...
        {loading ? (
          ...
          <div className="p-6 text-sm text-muted-foreground" data-testid="compliance-schedule-empty">
            {t(
      ...
      <section className="rounded-lg border border-border bg-card">
        ...
        <ul className="divide-y divide-border" data-testid="compliance-schedule-catalogue">
          {catalogue.map((tpl) => (
            <li key={tpl.template_key} className="flex items-center justify-between gap-3 px-4 py-3">
              <div className="min-w-0">
