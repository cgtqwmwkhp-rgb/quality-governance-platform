...
export default function Policies() {
  ...
  return (
    <div className="space-y-6 animate-fade-in" data-testid="policies-page">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage policies, procedures, and documents
          </p>
        </div>
          ...
          filteredPolicies.map((policy) => (
            <Card key={policy.id} hoverable className="p-5 cursor-pointer">
              ...
              <div className="mt-4 flex items-center justify-between">
                <Badge
                  variant={getStatusVariant(policy.status) as BadgeVariant}
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      review_frequency_months: parseInt(value),
                    })
                  }
                >
                  <SelectTrigger>
