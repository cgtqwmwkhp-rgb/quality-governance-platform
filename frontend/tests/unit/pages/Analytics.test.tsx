...
vi.mock('../../../src/api/client', () => ({
  ...
  analyticsApi: { getDashboard: vi.fn().mockResolvedValue({ data: {} }), getTrend: vi.fn().mockResolvedValue({ data: {} }), getTrends: vi.fn().mockResolvedValue({ data: {} }), getKPIs: vi.fn().mockResolvedValue({ data: {} }) },
...
describe('Analytics', () => {
  it('renders without crashing', async () => {
    ...
    const heading = await screen.findByText('Analytics Dashboard');
    expect(heading).toBeTruthy();
  });

  it('renders AI-Powered Insights section', async () => {
    render(
      <MemoryRouter>
        <Analytics />
      </MemoryRouter>
    ...
    const insights = await screen.findByText('AI-Powered Insights');
