...
vi.mock('../../../src/api/client', () => ({
  ...
  default: { get: vi.fn().mockResolvedValue({ data: { items: [], total_documents: 0, indexed_documents: 0, total_chunks: 0, by_status: {}, by_type: {} } }), post: vi.fn().mockResolvedValue({ data: {} }) },
}));
