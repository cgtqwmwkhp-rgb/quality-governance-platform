...
def auth_headers():
    ...
    pytest.skip(
        "QUARANTINED [GOVPLAT-003]: Auth headers require valid JWT. See tests/QUARANTINE_POLICY.yaml"
    )
...
def superuser_auth_headers():
    ...
    pytest.skip(
        "QUARANTINED [GOVPLAT-003]: Superuser auth requires JWT. See tests/QUARANTINE_POLICY.yaml"
    )
...
async def test_session():
    ...
    pytest.skip(
        "QUARANTINED [GOVPLAT-003]: Async DB session not configured. See tests/QUARANTINE_POLICY.yaml"
    )
...
def test_user():
    ...
    pytest.skip(
        "QUARANTINED [GOVPLAT-003]: Test user requires DB session. See tests/QUARANTINE_POLICY.yaml"
    )
...
def test_incident():
    ...
    pytest.skip(
        "QUARANTINED [GOVPLAT-003]: Test incident requires DB session. See tests/QUARANTINE_POLICY.yaml"
    )
