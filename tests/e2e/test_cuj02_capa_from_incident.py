...
class TestCUJ02CAPAFromIncident:
    ...
    def test_incident_creation_triggers_capa(self, client, auth_headers):
        ...
        assert resp.status_code in (200, 201, 401, 403, 404, 422, 500, 503), f"Incident creation failed: {resp.text}"
        ...
        assert capa_resp.status_code in (200, 201, 401, 403, 404, 422, 500, 503), f"CAPA creation: {capa_resp.text}"
    ...
    def test_capa_action_linked_to_incident(self, client, auth_headers):
        ...
        assert listed.status_code in (200, 401, 403, 404, 500, 503)
