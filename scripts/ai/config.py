...
class ClassificationConfig:
    ...
    complaint_categories: Dict[str, List[str]] = field(default_factory=lambda: {
    ...
    incident_types: Dict[str, List[str]] = field(default_factory=lambda: {
    ...
    urgency_indicators: Dict[str, List[str]] = field(default_factory=lambda: {
...
class RiskScoringConfig:
    ...
    type_risk_factors: Dict[str, float] = field(default_factory=lambda: {
        "SAFETY": 1.5,
        "SECURITY": 1.3,
        "ENVIRONMENTAL": 1.4,
        "QUALITY": 1.0,
    ...
    status_factors: Dict[str, float] = field(default_factory=lambda: {
        "REPORTED": 1.2,
        "IN_PROGRESS": 1.0,
        "CLOSED": 0.5,
    })
