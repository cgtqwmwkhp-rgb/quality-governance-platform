"""Fail-safe backfill + conditional NOT NULL for obsolete_document_records.tenant_id.

Revision ID: 20260711_odr_tenant_nn
Revises: 20260711_dv_tenant_nn
...
revision: str = "20260711_odr_tenant_nn"
down_revision: Union[str, Sequence[str], None] = "20260711_dv_tenant_nn"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

logger = logging.getLogger("alembic.runtime.migration")

TABLE = "obsolete_document_records"
