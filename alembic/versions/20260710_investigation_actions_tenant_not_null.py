"""Fail-safe backfill + conditional NOT NULL for investigation_actions.tenant_id.

Revision ID: 20260710_inv_act_nn
Revises: 20260710_capa_act_nn
...
revision: str = "20260710_inv_act_nn"
down_revision: Union[str, Sequence[str], None] = "20260710_capa_act_nn"
...
def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every investigation_actions row has a tenant_id."""
