"""Fail-safe backfill + conditional NOT NULL for investigation_comments.tenant_id.

Revision ID: 20260710_inv_cmt_nn
Revises: 20260710_inv_act_nn
...
revision: str = "20260710_inv_cmt_nn"
down_revision: Union[str, Sequence[str], None] = "20260710_inv_act_nn"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

logger = logging.getLogger("alembic.runtime.migration")

TABLE = "investigation_comments"
PARENT = "investigation_runs"
PARENT_KEY = "investigation_id"


def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every investigation_comments row has a tenant_id."""
