"""Fail-safe backfill + conditional NOT NULL for document_versions.tenant_id.

WCS-TEN2: inherit document_versions.tenant_id from documents via document_id.

Revision ID: 20260711_dv_tenant_nn
Revises: 20260711_doc_tenant_nn
...
revision: str = "20260711_dv_tenant_nn"
down_revision: Union[str, Sequence[str], None] = "20260711_doc_tenant_nn"
...
def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every document_versions row has a tenant_id."""
...
def upgrade() -> None:
    ...
    msg = (
        ...
        "Likely parent documents.tenant_id is still NULL; do not invent tenant_id=1. "
