"""Fail-safe backfill + conditional NOT NULL for risk_control_mappings.tenant_id.

WCS-TEN2: inherit risk_control_mappings.tenant_id from risks_v2 via risk_id.

Revision ID: 20260711_rcm_tenant_nn
...
revision: str = "20260711_rcm_tenant_nn"
down_revision: Union[str, Sequence[str], None] = "20260711_bow_tenant_nn"
...
def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every risk_control_mappings row has a tenant_id."""
