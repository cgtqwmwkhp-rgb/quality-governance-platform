...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('dependencies', _json_type(), nullable=True),
        sa.Column('dependent_processes', _json_type(), nullable=True),
        sa.Column('applied_controls', _json_type(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('attribute_types', _json_type(), nullable=True),
        ...
        sa.Column('implementation_evidence', _json_type(), nullable=True),
        ...
        sa.Column('related_policies', _json_type(), nullable=True),
        sa.Column('related_procedures', _json_type(), nullable=True),
        sa.Column('related_assets', _json_type(), nullable=True),
        sa.Column('related_risks', _json_type(), nullable=True),
        sa.Column('cross_references', _json_type(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('affected_assets', _json_type(), nullable=True),
        ...
        sa.Column('applicable_controls', _json_type(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('cia_impact', _json_type(), nullable=True),
        sa.Column('affected_assets', _json_type(), nullable=True),
        sa.Column('affected_systems', _json_type(), nullable=True),
        sa.Column('data_compromised', sa.Boolean(), nullable=False, default=False),
        sa.Column('data_types_affected', _json_type(), nullable=True),
        ...
        sa.Column('related_risks', _json_type(), nullable=True),
        sa.Column('related_controls', _json_type(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('critical_processes', _json_type(), nullable=True),
        ...
        sa.Column('key_personnel', _json_type(), nullable=True),
        sa.Column('contact_information', _json_type(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('data_types_accessed', _json_type(), nullable=True),
        ...
        sa.Column('other_certifications', _json_type(), nullable=True),
        sa.Column('findings', _json_type(), nullable=True),
        ...
        sa.Column('sla_requirements', _json_type(), nullable=True),
        sa.Column('security_requirements', _json_type(), nullable=True),
