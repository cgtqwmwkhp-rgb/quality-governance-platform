"""Fail-safe backfill + conditional NOT NULL for key_risk_indicators.tenant_id.

WCS-TEN2: inherit key_risk_indicators.tenant_id from risks_v2 via risk_id.

Revision ID: 20260711_kri_tenant_nn
...
revision: str = "20260711_kri_tenant_nn"
down_revision: Union[str, Sequence[str], None] = "20260711_rcm_tenant_nn"
...
def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every key_risk_indicators row has a tenant_id."""
