"""Fail-safe backfill + conditional NOT NULL for investigation_customer_packs.tenant_id.

Revision ID: 20260710_inv_pack_nn
Revises: 20260710_ir_tenant_nn
...
revision: str = "20260710_inv_pack_nn"
down_revision: Union[str, Sequence[str], None] = "20260710_ir_tenant_nn"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

logger = logging.getLogger("alembic.runtime.migration")

TABLE = "investigation_customer_packs"
PARENT = "investigation_runs"
PARENT_KEY = "investigation_id"


def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every investigation_customer_packs row has a tenant_id."""
