"""Fail-safe backfill + conditional NOT NULL for incidents.tenant_id.

Revision ID: 20260710_inc_tenant_nn
Revises: 20260710_ext_draft_nn
...
incidents is a parent core entity (children such as incident_actions already
...
revision: str = "20260710_inc_tenant_nn"
down_revision: Union[str, Sequence[str], None] = "20260710_ext_draft_nn"
...
def should_enforce_not_null(remaining_null_count: int) -> bool:
    """Return True only when every incidents row has a tenant_id."""
...
def _align_mismatches_to_parent() -> None:
    """Prefer creator ownership when incident.tenant_id differs from creator.tenant_id.
