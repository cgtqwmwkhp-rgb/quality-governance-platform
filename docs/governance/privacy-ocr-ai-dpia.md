...
4. Record DPO residual-risk acceptance against EA-03 in [`../evidence/external-attestation-tracker.md`](../evidence/external-attestation-tracker.md) — the acceptance on file covers the earlier two-processor scope only.
