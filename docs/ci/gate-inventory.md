...
| 10 | **Integration Tests** | Alembic up/down safety; quarantine policy; `pytest tests/integration/` (≥42% cov, `--cov-fail-under=42`) | Blocking | `coverage.xml`, `junit-integration.xml` → artifacts |
