...
| 10 | **Integration Tests** | Alembic up/down safety; quarantine policy; `pytest tests/integration/` (≥43% cov, `--cov-fail-under=43`) | Blocking | `coverage.xml`, `junit-integration.xml` → artifacts |
