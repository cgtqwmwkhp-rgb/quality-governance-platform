    ...
    async def create_incident(
        ...
        *,
        ...
        incident = Incident(
            ...
            is_minor_injury=bool(data.get("is_minor_injury", False)),
            is_riddor_reportable=data.get("is_riddor_reportable"),
            riddor_classification=data.get("riddor_classification"),
            riddor_rationale=data.get("riddor_rationale"),
