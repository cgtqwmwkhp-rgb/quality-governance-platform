"""Auditor Competence Management Service (canonical domain implementation).

Provides services for managing auditor qualifications,
competencies, and skill-based assignment.

Callers may import via ``src.domain.services.auditor_competence`` or the
compatibility re-export at ``src.services.auditor_competence``.
"""
