...
_ISO_9001_CLAUSES: List[Tuple[str, str, str, int, Optional[str]]] = [
    ...
    (
        "6.3",
        "Planning of changes",
        "Changes to QMS shall be carried out in a planned manner",
        2,
        "6",
    ),
    (
    ...
    (
        "7.3",
        "Awareness",
        "Persons shall be aware of quality policy and objectives",
        2,
        "7",
    ),
...
_ISO_14001_CLAUSES: List[Tuple[str, str, str, int, Optional[str]]] = [
    ...
    (
        ...
        "Determine boundaries of the EMS",
        2,
        "4",
    ),
    (
...
_ISO_45001_CLAUSES: List[Tuple[str, str, str, int, Optional[str]]] = [
    ...
    (
        "4.1",
        "Understanding the organization and its context",
        "Determine issues affecting OH&S performance",
        2,
        "4",
    ),
    (
    ...
    (
        ...
        "Establish, implement, maintain the OHSMS",
        2,
        "4",
    ),
    (
    ...
    (
        "6.1",
        "Actions to address risks and opportunities",
        "Determine hazards, risks, opportunities",
        2,
        "6",
    ),
    (
...
_ISO_27001_CLAUSES: List[Tuple[str, str, str, int, Optional[str]]] = [
    ...
    (
        "6.1.1",
        "General",
        "Consider issues and requirements when planning the ISMS",
        3,
        "6.1",
    ),
    (
    ...
    (
        ...
        "Define and apply risk treatment process",
        3,
        "6.1",
    ),
    (
    ...
    (
        "6.3",
        "Planning of changes",
        "Changes to ISMS shall be carried out in a planned manner",
        2,
        "6",
    ),
    (
    ...
    (
        "7.2",
        "Competence",
        "Determine competence of persons affecting information security",
        2,
        "7",
    ),
    (
        "7.3",
        "Awareness",
        "Persons shall be aware of information security policy",
        2,
        "7",
    ),
    (
        "7.4",
        "Communication",
        "Determine internal and external communications for ISMS",
        2,
        "7",
    ),
    (
        ...
        "ISMS shall include required documented information",
        2,
        "7",
    ),
    ("8", "Operation", "Operational planning and control", 1, None),
    (
        "8.1",
        "Operational planning and control",
        "Plan, implement and control processes for ISMS",
        2,
        "8",
    ),
    (
...
async def _seed_cross_standard_mappings(db: AsyncSession) -> None:
    ...
    logger.info(
        "Seeding cross-standard ISO clause mappings (%d mappings)",
        len(_CROSS_STANDARD_MAPPINGS),
    )
