"""UVDB Verify B2 protocol single source of truth (v11.8 target).
...
def build_content_coverage() -> dict[str, Any]:
    ...
    loaded_question_count = _count_questions([s for s in UVDB_B2_SECTIONS if s.get("content_status") == "loaded"])
...
UVDB_B2_SECTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "questions": [
            {"number": "15.1", "text": "Total Man Hours Worked", "type": "kpi_numeric", "years": 5},
            {"number": "15.2", "text": "Fatalities", "type": "kpi_numeric", "years": 5},
            {"number": "15.3", "text": "HSE Reportable Injuries (RIDDOR)", "type": "kpi_numeric", "years": 5},
            {"number": "15.4", "text": "Lost Time Incidents (1-7 days)", "type": "kpi_numeric", "years": 5},
            {
                "number": "15.5",
            ...
            {"number": "15.6", "text": "Incidents Requiring First Aid", "type": "kpi_numeric", "years": 5},
            {"number": "15.7", "text": "Dangerous Occurrences", "type": "kpi_numeric", "years": 5},
            {"number": "15.8", "text": "Near Hits/Misses", "type": "kpi_numeric", "years": 5},
            {"number": "15.9", "text": "HSE/HSA Improvement Notices", "type": "kpi_numeric", "years": 5},
            {"number": "15.10", "text": "HSE/HSA Prohibition Notices", "type": "kpi_numeric", "years": 5},
            {"number": "15.11", "text": "HSE/HSA Prosecutions", "type": "kpi_numeric", "years": 5},
            {
                "number": "15.12",
            ...
            {"number": "15.13", "text": "Environmental Reportable Incidents", "type": "kpi_numeric", "years": 5},
            {
                "number": "15.14",
