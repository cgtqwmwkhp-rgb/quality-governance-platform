...
class RiskNote(Base):
    ...
    __table_args__ = (Index("ix_risk_notes_tenant_risk_created", "tenant_id", "risk_id", "created_at"),)
...
class RiskActivityEvent(Base):
    ...
    __table_args__ = (Index("ix_risk_activity_events_tenant_risk_created", "tenant_id", "risk_id", "created_at"),)
    ...
    payload: Mapped[Optional[dict]] = mapped_column(_PG_JSONB().with_variant(JSON, "sqlite"), nullable=True)
