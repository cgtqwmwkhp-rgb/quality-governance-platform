...
class CollaborativeDocument(Base):
    ...
    __table_args__ = (
        Index("ix_collab_doc_entity", "entity_type", "entity_id"),
    )
...
class CollaborativeSession(Base):
    ...
    __table_args__ = (
        Index("ix_collab_session_active", "is_active", "last_seen_at"),
    )
...
class CollaborativeChange(Base):
    ...
    __table_args__ = (
        Index("ix_collab_change_doc", "document_id", "created_at"),
    )
