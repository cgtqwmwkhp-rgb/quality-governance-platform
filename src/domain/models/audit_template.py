...
class AuditTemplate(Base):
    ...
    # Relationships
    sections = relationship("AuditTemplateSection", back_populates="template", cascade="all, delete-orphan", order_by="AuditTemplateSection.order")
...
class AuditTemplateSection(Base):
    ...
    questions = relationship("AuditTemplateQuestion", back_populates="section", cascade="all, delete-orphan", order_by="AuditTemplateQuestion.order")
...
class AuditRun(Base):
    ...
    # Status
    status = Column(String(50), nullable=False, default="scheduled")  # scheduled, in_progress, pending_review, completed
...
class AuditFinding(Base):
    ...
    # Status
    status = Column(String(50), nullable=False, default="open")  # open, in_progress, pending_verification, closed, deferred
