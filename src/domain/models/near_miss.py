...
class NearMiss(Base):
    ...
    preventive_action_suggested: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )

    # People involved
    persons_involved: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    ...
    potential_severity: Mapped[Optional[str]] = mapped_column(
