...
async def get_fleet_summary(
    ...
    for r in records:
        ...
        vehicles[r.vehicle_registration]["total_litres"] += r.fuel_litres  # type: ignore[operator, assignment]  # TYPE-IGNORE: MYPY-OVERRIDE
        vehicles[r.vehicle_registration]["total_co2e_kg"] += r.co2e_kg  # type: ignore[operator, assignment]  # TYPE-IGNORE: MYPY-OVERRIDE
        if r.mileage:
            vehicles[r.vehicle_registration]["total_mileage"] += r.mileage  # type: ignore[operator, assignment]  # TYPE-IGNORE: MYPY-OVERRIDE
