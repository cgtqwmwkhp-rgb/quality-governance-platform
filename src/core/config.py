...
class Settings(BaseSettings):
    ...
    # FB-PR5: staff/API write of compliment/suggestion/general. Default on.
    # CUSTOMER_FEEDBACK_KINDS_ENABLED=false still subtracts. Routes stay /complaints.
    customer_feedback_kinds_enabled: bool = True
